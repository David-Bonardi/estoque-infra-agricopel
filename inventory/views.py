...
from .models import Asset, Balance, Branch, Movement
from .services import record_movement


@login_required
@permission_required(('inventory.view_balance', 'inventory.view_asset'), raise_exception=True)
def dashboard(request):
    ...
    if query:
        balances = balances.filter(item__name__icontains=query)
